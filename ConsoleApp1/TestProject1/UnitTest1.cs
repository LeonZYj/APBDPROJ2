...
public class UnitTest
{
    ...
    public void CheckAdd()
    {
        ...
        DeviceManager deviceManager = new DeviceManager("anypath.txt");
        deviceManager.AddDevice(personalComputer);
    ...
    public void CheckRemove()
    {
        ...
        deviceManager.RemoveDevice("P001");

        var devicesafterRemove = deviceManager.GetDevices();
...
// }
    ...
    public void CheckTurnOn()
    {
        ...
        var devicesBeforeTurnOn = deviceManager.GetDevices();
        Assert.Equal(false, devicesBeforeTurnOn[0].IsTurnedOn);

        deviceManager.TurnOnDevice("P001");

        var devicesAfterTurnOn = deviceManager.GetDevices();
    ...
    public void CheckTurnOff()
    {
        ...
        var devicesBeforeTurnOff = deviceManager.GetDevices();
        Assert.Equal(true, devicesBeforeTurnOff[0].IsTurnedOn);

        deviceManager.TurnOffDevice("P001");

        var devicesAfterTurnOff = deviceManager.GetDevices();
